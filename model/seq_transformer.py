...
from layer.embedding_layer import CheckinEmbedding
from layer.st_encoder import PositionEncoder
...
class SequentialTransformer(nn.Module):
    ...
    def generate_sequential_input(self, sequential_feature, device, max_length):
        """
        Generate sequential input for sequential model为顺序模型生成顺序输入
        """
